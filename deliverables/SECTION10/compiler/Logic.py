...
from Structure import Term, Node,SKeyword,SSymbol,SIntegerConstant,SStringConstant,SIdentifier,SClass,SClassVarDec,SSubroutineDec,SParameterList,SSubroutineBody,SVarDec,SStatement,SLetStatement,SDoStatement,SIfStatement,SWhileStatement,SExpression,STerm,SExpressionList
